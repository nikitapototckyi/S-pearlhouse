<?php
session_start();
$pass='pearlouse'; // Пароль для входа в Админку
...
if((isset($_POST['slovo'])||isset($_POST['sekret']))||($_SESSION['sekret']==md5($pass))){
    ...
    line-height: 24px;
    font-size: 31px;
    font-family: sans-serif;">Авторизация pearlouse</div>
    ...
    text-align: center;"><br>
			<input type=submit name="save" value="Авторизоваться" style="  width: 300px;
  padding-top: 19px;
  padding-bottom: 22px;
...
<br><br><br><p><a href="" target="_blank">В</a><br><br>
		 </div>');
};
